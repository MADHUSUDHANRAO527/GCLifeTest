...
public class AddFlats extends ActionBarActivity {
	android.support.v7.app.ActionBar actionBar;
	Typeface typefaceLight;
	TextView finishTxt;
	String hostname, avenueName, societyName, buildingNum, flatType, ownerType,
	...
	RelativeLayout reltionwithOwnerLay, line6;
	Editor editor;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ownerTypeSpinner
				.setOnItemSelectedListener(new OnItemSelectedListener() {
					...
					public void onItemSelected(AdapterView<?> arg0, View arg1,
						...
						if (ownerType == "Licensee Owner"
								|| ownerType.equals("Licensee Owner")
								|| ownerType == "Dependent Owner"
								|| ownerType.equals("Dependent Owner")) {
		...
		finishTxt.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				} else if (ownerType == "Dependent Owner"
						&& ownerType.equals("Dependent Owner")
						&& realtionShipWithOwner == null
						&& realtionShipWithOwner.equals(null)
						&& realtionShipWithOwner == "null") {
					showSnack(AddFlats.this,
							"Please select a relation with owner!", "OK");
				} else if (liscenseDateStr.equals("") || liscenseDateStr == "") {
					showSnack(AddFlats.this, "select a license end date!", "OK");
				} else {
