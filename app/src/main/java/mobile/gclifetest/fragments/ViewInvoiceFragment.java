...
public class ViewInvoiceFragment extends Fragment {
        ...
        webView.post(new Runnable() {
            ...
            public void run() {
             ...
             //   webView.loadUrl("http://35.166.172.142/GcLife/index.html?ResidentId="+ userPref.getString("USERID", "NV"));
                ...
                webView.loadUrl(GclifeApplication.HOSTNAME_PAYMENT+"Inv_PaymentHistory.php?BillNo="+GclifeApplication.getInstance().getBillIdForPayment());
               // http://35.166.172.142/Inv_PaymentHistory.php?BillNo=1518
                Log.d("Payment History invoice",GclifeApplication.HOSTNAME_PAYMENT+"Inv_PaymentHistory.php?BillNo="+GclifeApplication.getInstance().getBillIdForPayment());
    ...
    public void onResume() {
        ...
        ((HomeActivity) context).changeToolbarTitle(R.string.view_invoice);
    }
