...
public class GalleryImageViewer extends BaseActivity {
    ...
    List<EventImages> eventImagesPojo; Gson gson = new Gson();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		eventImagesPojo = gson.fromJson(images.toString(), new TypeToken<List<EventImages>>() {
		}.getType());
		...
		try {
			...
			if (jsonArray != null) {
				...
				for (int i = 0; i < len; i++) {
					arrayList.add(eventImagesPojo.get(i).getImage_url());
				}
			}
